                ...
                <div className="lg:col-span-1">
                  ...
                  >
                    ...
                    <form onSubmit={handleCheckout} className="space-y-4">
                      ...
                      <div className="mt-4 p-4 bg-[#e7f0fd] rounded-xl border border-[#b3c9f7]">
                        <p className="text-sm text-[#1e3a5f] font-medium mb-2 text-center">
                          Không muốn mua qua web?
                        </p>
                        <a
                          href="https://www.facebook.com/profile.php?id=61587336933677"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center justify-center gap-2 w-full py-2.5 bg-[#4267B2] text-white rounded-lg font-semibold hover:bg-[#5b7bd5] transition"
                        >
                      ...
                      <Link
                        to="/products"
                        className="block text-center text-sm text-[#704214] hover:text-[#8B5A2B] mt-2"
                      >
                        ← Tiếp tục mua sắm
                      </Link>
                    </form>
